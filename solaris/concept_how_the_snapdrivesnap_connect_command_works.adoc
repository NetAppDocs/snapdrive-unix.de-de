...
* Wenn Sie angeben `autorename` Option mit dem Befehl Snap connect werden Host-Volumes und Dateisysteme immer umbenannt. Die Laufwerksgruppen werden nur umbenannt, wenn sie bereits auf dem Host vorhanden sind.
